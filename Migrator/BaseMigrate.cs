...
namespace Migrator
{
	...
	{
        protected readonly TransformationProviderBase _provider;
        ...
        public static BaseMigrate GetInstance(List<long> availableMigrations, TransformationProviderBase provider, ILogger logger)
		{
