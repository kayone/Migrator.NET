...
{
    ///<summary>
    ///  A migration is a group of transformation applied to the database schema (or sometimes data) to port the database from one version to another. The <c>Up()</c> method must apply the modifications (eg.: create a table) and the <c>Down()</c> method must revert, or rollback the modifications (eg.: delete a table). <para>Each migration must be decorated with the
    ///                                                                                                                                                                                                                                                                                                                           <c>[Migration(0)]</c>
    ///                                                                                                                                                                                                                                                                                                                           attribute.
    ///                                                                                                                                                                                                                                                                                                                           Each migration number (0) must be unique, or else a
    ///                                                                                                                                                                                                                                                                                                                           <c>DuplicatedVersionException</c>
    ///                                                                                                                                                                                                                                                                                                                           will be trown.</para> <para>All migrations are executed inside a transaction. If an exception is
    ///                                                                                                                                                                                                                                                                                                                                                   thrown, the transaction will be rolledback and transformations wont be
    ///                                                                                                                                                                                                                                                                                                                                                   applied.</para> <para>It is best to keep a limited number of transformation inside a migration
    ...
    ///                                                                                                                                                                                                                                                                                                                                                                     .</para> <para>Use the
    ///                                                                                                                                                                                                                                                                                                                                                                                <c>Database</c>
    ///                                                                                                                                                                                                                                                                                                                                                                                property to apply transformation and the
    ///                                                                                                                                                                                                                                                                                                                                                                                <c>Logger</c>
    ///                                                                                                                                                                                                                                                                                                                                                                                property to output informations in the console (or other).
    ///                                                                                                                                                                                                                                                                                                                                                                                For more details on transformations see
    ///                                                                                                                                                                                                                                                                                                                                                                                <see cref="ITransformationProvider">ITransformationProvider</see>
    ///                                                                                                                                                                                                                                                                                                                                                                                .</para>
    ///</summary>
    ///<example>
    ///  The following migration creates a new Customer table. (File <c>003_AddCustomerTable.cs</c> ) <code>[Migration(3)]
    ...
    public abstract class Migration : IMigration
    {
        ...
        /// <summary>
        ///   Represents the database. <see cref="ITransformationProvider"></see> .
        /// </summary>
