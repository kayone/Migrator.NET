...
namespace Migrator.Framework
{
    public interface ILogger
    {
        ...
        /// <summary>
        ///   Inform that a migration corresponding to the number of version is untraceable (not found?) and will be ignored.
        /// </summary>
        ...
        /// </summary>
        /// <param name="originalVersion"> version </param>
        ...
        /// </summary>
        /// <remarks>
        ///   SELECT statements should not be logged using this method as they do not alter the data or schema of the database.
        /// </remarks>
